...
import com.example.navigationview.activity.ForgetPwdActivity;
...
public class GalleryFragment extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Button b4=root.findViewById(R.id.update);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "该APP主要是通过对农业环境的远程实时监控以" +
                        "及设置报警阈值等功能来保证农业生产基地处于一个较佳的运行环境，同时确保农作物的正" +
                        "常生长。", Toast.LENGTH_LONG).show();
            }
        });

...
public class SensorActivity extends AppCompatActivity {
    ...
    public static final String URL = "tcp://192.168.139.253:1883";
    private String userName = "android";
    private String password = "android";
    private String clientId = "1940707245";
   ...
   //String cmdon = "1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCo2 = (TextView) findViewById(R.id.vofIllu);
        txtLight = (TextView) findViewById(R.id.vofIllu2);
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
        ...
        if(msg[0].equals("sensor"))
        {
            ...
            String ill = jsonObject.getString("co2");
            String ill2 = jsonObject.getString("light");
            txtCo2.setText(ill);
            txtWenDu.setText(tem);
            txtShiDu.setText(hum);
            txtLight.setText(ill2);
        }

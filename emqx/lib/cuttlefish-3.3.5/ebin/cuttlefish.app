{application,cuttlefish,
             [{description,"cuttlefish configuration abstraction"},
              ...
              {modules,[conf_parse,cuttlefish,cuttlefish_advanced,
                        ...
                        cuttlefish_mapping,cuttlefish_markdown,
                        cuttlefish_rebar_plugin,cuttlefish_schema,
                        cuttlefish_translation,cuttlefish_util,
                        cuttlefish_validator,cuttlefish_variable,
                        cuttlefish_vmargs]}]}.
